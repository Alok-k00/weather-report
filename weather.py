...
def data_get():
    city = city_name.get()
    data = requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=5d5775935e6b7f3a2765d3b960fceabf").json()
...
tem_label = Label(win, text="Weather Temperature", font=("Times New Roman", 17,))
tem_label.place(x=25, y=400, height=50, width=210)

tem_label1 = Label(win, text="", font=("Times New Roman", 17,))
tem_label1.place(x=250, y=400, height=50, width=210)


per_label = Label(win, text="Weather pressure", font=("Times New Roman", 17,))
